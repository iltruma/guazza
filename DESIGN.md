...
## 7. Librerie client-side (CDN jsDelivr)

Riferimento on-demand per il setup tecnico delle dipendenze frontend. Il design
system è nelle sezioni 1-6 sopra.

Il frontend usa **CSS custom** (`style.css`, classi prefissate `g-*`) — nessun framework
CSS (Tailwind/DaisyUI rimossi nel redesign v2). Font caricati via CDN:
